...
/**
* check_elf - this confirms a file if it is an ELF file.
...
{
if
(e_ident[index] != 127 && e_ident[index] != 'E' && e_ident[index] != 'L' && e_ident[index] != 'F')
{
...
/**
* main - Outputs the information contained in the
